In the book Design Patterns Elements of Reusable OO Code, each pattern has UML/ORM figure with Participants Site the name of the participant and describe its function/usages in the diagram direct your comments to a 2nd year college C++ student for the design pattern Factory
